...
public class OrderController {
	...
	public ResponseEntity<List<OrderResponse>> findAllOrdersByUser(@PathVariable Long userId) {
		List<OrderResponse> orders = orderService.findAllOrdersByUserId(userId);
